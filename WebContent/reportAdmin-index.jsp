...
<body>
	<div class="header overlap" style="background-color: #52a6fa">
       ...
       String data;
       if(query != null){
    	   data = "select * from report where rid like '%"+query+"%' or rname like '%"+query+"%'";
       } else{
       ...
       <tr>
         ...
         &nbsp;&nbsp;&nbsp;&nbsp;<a href='report-delete.jsp?d=<%=res.getString("rid")%>' onclick="return confirm('Are you sure, you want to delete it?')">Delete</a>
         </td>
        </tr>
        <%
       }
