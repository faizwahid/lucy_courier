...
<div class="et-hero-tabs-container">
      ...
      <a class="et-hero-tab" href="parcel-index.jsp">Parcel</a>
      <a class="et-hero-tab" href="report-index.jsp">Report</a>
   ...
   <header> 
         ...
         <div>
            ...
            <h1 style="color:#000000;">Staff, ${staff.name}</h1>
            <h5>Welcome to Lucytech Courier Panel</h5>
            <h3><a href="logoutStaff">Logout</a></h3>
          </div>
            </nav>
      </header>
            <br>
...
<table style="background-color:#fff" class="table table-bordered table-striped table-hover">
   <thead style="background-color: #fff">
    ...
    <tbody>
       ...
       String data;
       if(query != null){
    	   data = "select * from staff where fullname like '%"+query+"%' or email like '%"+query+"%' or id like '%"+query+"%'";
       } else{
