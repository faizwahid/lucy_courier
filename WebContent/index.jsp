...
<table style="background-color:#fff" class="table table-bordered table-striped table-hover">
   <thead style="background-color: #fff">
    ...
    <tbody>
       ...
       String data;
       if(query != null){
    	   data = "select * from users where fullname like '%"+query+"%' or email like '%"+query+"%' or id like '%"+query+"%'";
       } else{
    	   data = "select * from users order by id";
       }
       ...
       <tr>
         ...
         <td class="text-center">
           <a href='user-update.jsp?u=<%=res.getInt("id")%>' class="btn btn-warning" style= "color: #fff; background-color: #00af91; border-color: #00af91 ;">Edit</a>
           <a href='Delete.jsp?d=<%=res.getInt("id")%>' class="btn btn-danger" style="background-color:#ec5858;">Delete</a>
         </td>
        </tr>
        <%
       }
