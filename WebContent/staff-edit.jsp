   ...
   <header>
         ...
         <div>
			...
			<div class="row">
                ...
                <div class="container">
                    <h3 class="text-center">Edit Staff Details</h3>
                    <hr>
       <%
       ...
       String data = "select * from staff where id='"+u+"'";
       ...
       %>
            <input type="hidden" name="id" value='<%=res.getString("id") %>'/>
   			...
   			<div class="form-group">
				...
				<input type="text" class="form-control" name="password" value='<%=res.getString("password") %>'/>
   			</div>
   			<%
            }
   			%>
   			<a href="staff-index.jsp" class="btn btn-default">Back</a>
   			...
   			if(a!=null && b!=null && c!=null && d!=null && e!=null){
   				String query = "update staff set name=?, address=?,email=?,password=? where id='"+a+"'";
