   ...
   <header>
         ...
         <div>
            ...
            <div class="row">
                ...
                <div class="container">
                    <h3 class="text-center">Add Staff Details</h3>
                    <hr>
					<form action="" method="post">
					   ...
					   <a href="staff-index.jsp" class="btn btn-default text-center">Back</a>
...
if(a!=null && b!=null && c!=null && d!=null){
	...
	String data = "insert into staff(name,address,email,password) values(?,?,?,?)";
